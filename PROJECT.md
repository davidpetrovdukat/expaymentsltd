...
- **Data Fetching:** All initial data fetching MUST occur in Server Components. Pass data down as props.
- **Mutations:** ONLY use Next.js Server Actions for data mutations. API Routes (/app/api/...) are strictly reserved for external webhooks.
- **Form Validation:** All forms MUST use react-hook-form coupled with zod resolvers.
